...
export const CurrentListingsSection = () => {
  ...
  return (
    <>
        <MotionWrapper>
            <section className="oresta-section border-b-2 border-gray-200">
                ...
                <ul className="flex flex-col mb-10">
                    ...
                    <li><h4 className="text-center sm:text-xl">$839,000</h4></li>
                </ul>
        ...
        <MotionWrapper>
            <section className="oresta-section">
                <ul className="flex flex-col mb-10">
                    ...
                    <li><h4 className="text-center sm:text-xl">3 Beds, 3 Baths, 6 Rooms Semi-Detached</h4></li>
