  ...
  return (
    <header className="flex flex-col sticky top-0 z-50">
        ...
        <div className="h-[55px] px-3 md:px-5 bg-oresta-blue text-oresta-gray flex justify-between items-center">
            ...
            <a href={`tel:${PHONE_NUMBER.raw}`} className="flex flex-row md:ms-auto md:me-8 items-center hover:text-oresta-moss text-sm md:text-[0.9rem]">
                <FiPhoneCall className="hidden md:block me-2" />{PHONE_NUMBER.display}
            </a>
