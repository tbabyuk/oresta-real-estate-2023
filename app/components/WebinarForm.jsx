...
export const WebinarForm = () => {
  ...
  return (
    <>
    {sent ? 
      (<p className="text-lg text-green-500">Congratulations - you have successfully registered for the Webinar!<br /> Please use the following link to join the webinar: <a href="https://us06web.zoom.us/j/84742986150" target="_blank" className="text-gray-50 hover:underline">https://us06web.zoom.us/j/84742986150</a></p>) : 
